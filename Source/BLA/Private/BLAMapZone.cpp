...
void ABLAMapZone::OnConstruction(const FTransform& Transform)
{
...
bool ABLAMapZone::ContainsActor(AActor* Actor) const
{
    return Actor != nullptr && ContainsLocation(Actor->GetActorLocation());
}

bool ABLAMapZone::ContainsLocation(const FVector& Location) const
{
