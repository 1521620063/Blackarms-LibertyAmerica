...
Offline tactical team FPS MVP built with Unreal Engine 5.8.2 (CL 56702186) for Windows PC.

## Open The Project

1. Install Unreal Engine 5.8.2.
2. Open `FPS.uproject` from this repository root.
3. Let Unreal compile shaders and discover assets on the first launch.
4. Open `/Game/FPS/Maps/Graybox/L_TestBootstrap` if it is not already loaded.
