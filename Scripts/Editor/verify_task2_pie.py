...
VALIDATOR_CLASS = unreal.BLAGameplayDataValidator
VALIDATOR_LABEL = "BLA Gameplay Data Validator"
...
def finish(success, message):
    ...
    log(f"BLA_TASK2_PIE_DRIVER_{'OK' if success else 'FAILED'} {message}")
    state["ending"] = True
...
unreal.log("BLA_TASK2_PIE_DRIVER_STARTED")
