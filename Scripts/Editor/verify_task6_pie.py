...
VALIDATOR_CLASS = unreal.BLAAITestFixture
VALIDATOR_LABEL = "BLA AI Test Fixture"
...
def finish(success, message):
    ...
    log(f"BLA_TASK6_PIE_DRIVER_{'OK' if success else 'FAILED'} {message}")
    state["ending"] = True
...
unreal.log("BLA_TASK6_PIE_DRIVER_STARTED")
